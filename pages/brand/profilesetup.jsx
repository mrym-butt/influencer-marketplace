      ...
      <div className="  px-4 py-5 sm:rounded-lg sm:p-6">
        <div className="md:grid md:grid-cols-3 md:gap-6">
          ...
          <div className="mt-5 md:mt-0 md:col-span-2">
            <form action="#" method="POST" onSubmit={handleprofileupdate}>
                ...
                <div className="w-1/2">
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <Input
                      ...
                      id="name"
                      autoComplete="name"
                      value={userInfo ? userInfo.name: ""} // Populate value from userInfo
                        onChange={(e) =>
                          setUserInfo({
                            ...userInfo,
                            name: e.target.value,
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <Input
                      ...
                      id="email-address"
                      autoComplete="email"
                      value={userInfo ? userInfo.email: ""} // Populate value from userInfo
                        onChange={(e) =>
                          setUserInfo({
                            ...userInfo,
